...
angular.module('kityminderEditor')
	.directive('colorPicker', function() {
		return {
			restrict: 'E',
			templateUrl: 'ui/directive/colorPicker/colorPicker.html',
			scope: {
				minder: '='
			},
			link: function(scope) {
